...
public class Menu {
	...
	public Menu(int no, String menuId, String menuName, String type, int price, Integer size, byte[] image) {
		super();
		this.no = no;
		this.menuId = menuId;
	...
	public String toString() {
		return "Menu [no=" + no + ", menuId=" + menuId + ", menuName=" + menuName + ", type=" + type + ", price="
				+ price + ", size=" + size + ", image=" + Arrays.toString(image) + "]";
	}
